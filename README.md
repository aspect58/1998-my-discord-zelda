/*This Theme Uses Code From The Following Themes I DO NOT TAKE CREDIT FOR THE CODE USED FROM THEM,Please Check Them Out 
...
@keyframes cv-init2 {
	...
	50% {
		content: "Please download and start the plugin";
		opacity: 0;
		-webkit-transform: scale(.7);
		background: var(--Secondary-Background-Colour);
		transform: scale(.7)
	...
	75% {
		content: "https://nfld99.com/plugin";
		opacity: 0;
		-webkit-transform: scale(.7);
		background: var(--Secondary-Background-Colour);
		transform: scale(.7)
